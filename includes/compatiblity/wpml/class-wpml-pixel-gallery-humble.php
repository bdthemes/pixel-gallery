...
/**
 * Class WPML_Pixel_Gallery_Humble
 * Handles translation of repeater items in the Humble widget
 */
class WPML_Pixel_Gallery_Humble extends WPML_Module_With_Items {
