...
/**
 * Class WPML_Pixel_Gallery_Marron
 * Handles translation of repeater items in the Marron widget
 */
class WPML_Pixel_Gallery_Marron extends WPML_Module_With_Items {
