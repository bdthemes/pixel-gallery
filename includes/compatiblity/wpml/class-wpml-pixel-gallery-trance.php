...
/**
 * Class WPML_Pixel_Gallery_Trance
 * Handles translation of repeater items in the Trance widget
 */
class WPML_Pixel_Gallery_Trance extends WPML_Module_With_Items {
