...
/**
 * Class WPML_Pixel_Gallery_Xero
 * Handles translation of repeater items in the Xero widget
 */
class WPML_Pixel_Gallery_Xero extends WPML_Module_With_Items {
    ...
    protected function get_title( $field ) {
        switch ( $field ) {
            ...
            case 'hosted_url':
                return esc_html__( 'Hosted URL', 'pixel-gallery' );
            case 'link':
