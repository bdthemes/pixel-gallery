...
/**
 * Class WPML_Pixel_Gallery_Fabric
 * Handles translation of repeater items in the Fabric widget
 */
class WPML_Pixel_Gallery_Fabric extends WPML_Module_With_Items {
