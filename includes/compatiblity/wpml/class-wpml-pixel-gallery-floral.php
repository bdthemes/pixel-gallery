...
/**
 * Class WPML_Pixel_Gallery_Floral
 * Handles translation of repeater items in the Floral widget
 */
class WPML_Pixel_Gallery_Floral extends WPML_Module_With_Items {
