...
/**
 * Class WPML_Pixel_Gallery_Mosaic
 * Handles translation of repeater items in the Mosaic widget
 */
class WPML_Pixel_Gallery_Mosaic extends WPML_Module_With_Items {
