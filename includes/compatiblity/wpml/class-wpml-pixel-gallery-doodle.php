...
/**
 * Class WPML_Pixel_Gallery_Doodle
 * Handles translation of repeater items in the Doodle widget
 */
class WPML_Pixel_Gallery_Doodle extends WPML_Module_With_Items {
