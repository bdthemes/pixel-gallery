...
<div class="bdt-wizard-step bdt-text-center" data-step="finish">
    ...
    <div class="bdt-templates-section">
        ...
        <div class="template-list">
            ...
            ?>
                <div class="choose-template <?php echo esc_attr( $extension ); ?> <?php echo $extension =='zip' ? 'bdt-pg-import-temp-zip':'bdt-pg-import-temp-json' ?>" data-import-url="<?php echo esc_url( $importUrl ); ?>">
