jQuery(document).ready(function ($) {
    ...
    function renderFeedHTML(item) {
        ...
        return `
            <div id="${esc(feedId)}" class="pixel-gallery-feed">
    ...
    function injectPromotionMenu(promo) {
        ...
        var html = '<li class="ep-promo-menu-item"><a href="' + href + '" target="_blank" style="color: #f44336; font-weight: 600;" rel="noopener noreferrer">' + text + '</a></li>';
