...
<?php
	...
	#>
		...
		<# _.each( items, function( item, index ) {
			var eff = settings.verse_layout_style ? ' pg-verse-effect-' + settings.verse_layout_style : '';
				...
				<# if ( item.item_hidden !== 'yes' ) { #>
					...
					<div class="pg-verse-content">
						<# if ( settings.show_title === 'yes' && item.title ) { #>
							...
							<{{{ ttag }}} class="pg-verse-title">{{{ item.title }}}</{{{ ttag }}}>
						<# } #>
						<# if ( settings.show_text === 'yes' && item.text ) { #>
							<div class="pg-verse-text">{{{ item.text }}}</div>
						<# } #>
