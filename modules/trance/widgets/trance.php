...
class Trance extends Module_Base {
	...
	var gridClass = 'pg-trance-grid pg-grid';
	if ( settings.trance_select_design && settings.trance_select_design !== 'default' ) {
		gridClass += ' pg-trance-design-' + settings.trance_select_design;
	}
					...
					<div class="pg-trance-content">
						...
						<# if ( item.media_type === 'video' ) { #>
							<# if ( item.poster && item.poster.url ) { #>
								<img src="{{ item.poster.url }}" alt="{{ item.title }}" class="pg-trance-img">
							<# } #>
						<# } else if ( item.image && item.image.url ) { #>
							<img src="{{ item.image.url }}" alt="{{ item.title }}" class="pg-trance-img">
						<# } #>
...
<?php $this->print_content_template_lightbox_overlay( 'trance' ); ?>
					<# } #>
				<# } #>
			</div>
		<# } ); #>
