				...
				<# if ( item.item_hidden !== 'yes' ) { #>
						...
						<# if ( item.media_type === 'video' ) { #>
							<# if ( item.poster && item.poster.url ) { #>
								<img src="{{ item.poster.url }}" alt="{{ item.title }}" class="pg-punch-img">
							<# } #>
						<# } else if ( item.image && item.image.url ) { #>
							<img src="{{ item.image.url }}" alt="{{ item.title }}" class="pg-punch-img">
						<# } #>
					...
					<# if ( settings.link_to !== 'none' && ( settings.link_target || 'whole_item' ) === 'only_button' ) { #>
						<div class="pg-punch-readmore">
<?php $this->print_content_template_item_link_prepare( 'punch' ); ?>
...
<?php $this->print_content_template_lightbox_overlay( 'punch' ); ?>
					<# } #>
				<# } #>
			</div>
		<# } ); #>
