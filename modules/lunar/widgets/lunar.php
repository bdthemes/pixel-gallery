...
<?php
	...
	var gridClass = 'pg-lunar-grid pg-grid';
	...
	#>
		...
		<# _.each( items, function( item, index ) {
			var itemClass = 'pg-lunar-item pg-item elementor-repeater-item-' + item._id;
		#>
			<div class="{{ itemClass }}">
				<# if ( item.item_hidden !== 'yes' ) { #>
										<div class="pg-lunar-image-wrap bdt-pg-img-mask">
						<# if ( item.media_type === 'video' ) { #>
							<# if ( item.poster && item.poster.url ) { #>
								<img src="{{ item.poster.url }}" alt="{{ item.title }}" class="pg-lunar-img">
							<# } #>
						<# } else if ( item.image && item.image.url ) { #>
							<img src="{{ item.image.url }}" alt="{{ item.title }}" class="pg-lunar-img">
						<# } #>
					...
					<div class="pg-lunar-title-wrap">
						<# if ( settings.show_title === 'yes' && item.title ) { #>
							...
							<{{{ ttag }}} class="pg-lunar-title">{{{ elementor.helpers.sanitize( item.title ) }}}</{{{ ttag }}}>
						<# } #>
					</div>
					<div class="pg-lunar-icon"><i class="pg-icon-arrow-right"></i></div>
					<div class="pg-lunar-content">
						<# if ( settings.show_text === 'yes' && item.text ) { #>
							<div class="pg-lunar-text">{{{ elementor.helpers.sanitize( item.text ) }}}</div>
						<# } #>
						<# if ( settings.link_to !== 'none' && ( settings.link_target || 'whole_item' ) === 'only_button' && item.readmore_text ) { #>
							<div class="pg-lunar-readmore">
<?php $this->print_content_template_item_link_prepare( 'lunar' ); ?>
...
<?php $this->print_content_template_lightbox_overlay( 'lunar' ); ?>
					<# } #>
				<# } #>
			</div>
		<# } ); #>
